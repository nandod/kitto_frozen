...
3) Optionally edit database connection parameters in Home\Metadata\Config.yaml and Home\Metadata\ConfigEmbedded.yaml.
...
To see the application embedded in a web page, use ConfigEmbedded.yaml and access through an URL like:
